export const dict = {
  ...
  "dialog.provider.opencode.tagline": "Reliable PunkcodeAI Cloud models",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by PunkcodeAI",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in PunkcodeAI.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "PunkcodeAI Cloud gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.opencodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.opencodeZen.visit.prefix": "Visit ",
  "provider.connect.opencodeZen.visit.link": "punkcodeai.myverse.site",
  "provider.connect.opencodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in PunkcodeAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in PunkcodeAI.",
  ...
  "dialog.plugins.empty": "Plugins configured in punkcode.json",
  ...
  "dialog.server.description": "Switch which PunkcodeAI server this app connects to.",
  ...
  "toast.update.description": "A new version of PunkcodeAI ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the PunkcodeAI team",
  ...
  "error.chain.checkConfig": "Check your config (punkcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, PunkcodeAI does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "PunkcodeAI includes free models so you can start immediately.",
  ...
  "app.name.desktop": "PunkcodeAI Desktop",
  ...
  "settings.desktop.wsl.description": "Run the PunkcodeAI server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for PunkcodeAI",
  ...
  "settings.general.row.appearance.description": "Customise how PunkcodeAI looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether PunkcodeAI follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how PunkcodeAI is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when PunkcodeAI launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of PunkcodeAI.",
  ...
  // PunkcodeAI 桌面端登录 / 注册 / 账户页（M5）
  "auth.login.title": "Sign in",
  "auth.login.email": "Email",
  "auth.login.password": "Password",
  "auth.login.submit": "Sign in",
  "auth.login.toRegister": "Don't have an account? Sign up",
  "auth.login.failed": "Sign in failed: {{reason}}",
  "auth.register.title": "Create account",
  "auth.register.confirmPassword": "Confirm Password",
  "auth.register.passwordMismatch": "Passwords do not match",
  "auth.register.nickname": "Real Name",
  "auth.register.submit": "Create account",
  "auth.register.toLogin": "Already have an account? Sign in",
  "auth.register.failed": "Sign up failed: {{reason}}",
  "auth.register.emailHint": "Used as your login account; must be a valid email",
  "auth.register.passwordHint": "At least 6 characters",
  "auth.register.nicknameHint": "1–64 characters",
  "auth.logout.confirmTitle": "Sign out",
  "auth.logout.confirmMessage": "Sign out of your account? You'll need to sign in again.",
  ...
  // PunkcodeAI 桌面端余额 widget + 充值申请（M7）
  "balance.balance": "Balance",
  "balance.todayUsed": "Today",
  "balance.refresh": "Refresh",
  "balance.lowBalanceWarning": "Low balance",
  "topup.title": "Top-up Request",
  "topup.amount": "Amount (USD)",
  "topup.note": "Note (optional)",
  "topup.note.placeholder": "Tell the admin why (optional)",
  "topup.submit": "Submit",
  "topup.success": "Submitted, awaiting admin approval",
  "topup.tooManyPending": "You have {{count}} pending requests already; wait for admin approval before submitting more.",
  "topup.amountRange": "Amount must be between $1 and $10000",
  "topup.myRequests": "My Requests",
  "topup.myRequests.empty": "No requests yet.",
  "topup.openButton": "Top up",
