export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez PunkcodeAI",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w PunkcodeAI.",
  ...
  "provider.connect.opencodeZen.line1":
    "PunkcodeAI Cloud daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w PunkcodeAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w PunkcodeAI.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w punkcode.json",
  ...
  "dialog.server.description": "Przełącz serwer PunkcodeAI, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja PunkcodeAI ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu PunkcodeAI",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (punkcode.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "PunkcodeAI zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla PunkcodeAI",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd PunkcodeAI na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy PunkcodeAI ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw PunkcodeAI.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania PunkcodeAI",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji PunkcodeAI.",
