...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 PunkcodeAI Cloud 或 API 密钥连接",
  ...
  "dialog.model.unpaid.freeModels.title": "PunkcodeAI 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 PunkcodeAI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "PunkcodeAI Cloud 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 PunkcodeAI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 PunkcodeAI 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 punkcode.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 PunkcodeAI 服务器。",
  ...
  "toast.update.description": "PunkcodeAI 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 PunkcodeAI 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (punkcode.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: PunkcodeAI 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "PunkcodeAI 提供免费模型，你可以立即开始使用。",
  "sidebar.gettingStarted.line2": "连接任意提供商即可使用更多模型，如 Claude、GPT、Gemini 等。",
  "sidebar.project.recentSessions": "最近会话",
  "sidebar.project.viewAllSessions": "查看全部会话",
  "sidebar.project.clearNotifications": "清除通知",

  "app.name.desktop": "PunkcodeAI 桌面端",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 PunkcodeAI 服务器。",
  ...
  "settings.general.row.language.description": "更改 PunkcodeAI 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 PunkcodeAI 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 PunkcodeAI 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 PunkcodeAI 的主题。",
  ...
  "settings.updates.row.startup.description": "在 PunkcodeAI 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 PunkcodeAI。",
  ...
  "auth.login.toRegister": "还没账号？立即注册",
  "auth.login.failed": "登录失败：{{reason}}",
  "auth.register.title": "注册",
  "auth.register.confirmPassword": "确认密码",
  "auth.register.passwordMismatch": "两次输入的密码不一致",
  "auth.register.nickname": "真实姓名",
  "auth.register.submit": "创建账号",
  "auth.register.toLogin": "已有账号？立即登录",
  "auth.register.failed": "注册失败：{{reason}}",
  "auth.register.emailHint": "用作登录账号，需为有效邮箱地址",
  "auth.register.passwordHint": "至少 6 位字符",
  "auth.register.nicknameHint": "1～64 个字符",
  "auth.logout.confirmTitle": "退出登录",
  "auth.logout.confirmMessage": "确定要退出当前账号吗？退出后需重新登录。",
  "account.title": "账户",
  "account.email": "邮箱",
  "account.nickname": "昵称",
  "account.balance": "余额",
  "account.logout": "退出登录",
  "account.back": "返回",
  "account.signedInAs": "已以 {{email}} 登录",

  // PunkcodeAI 桌面端余额 widget + 充值申请（M7）
  "balance.balance": "余额",
  "balance.todayUsed": "今日",
  "balance.refresh": "刷新",
  "balance.lowBalanceWarning": "余额不足",
  "topup.title": "申请充值",
  "topup.amount": "金额（USD）",
  "topup.note": "备注（可选）",
  "topup.note.placeholder": "可选：告诉管理员理由",
  "topup.submit": "提交申请",
  "topup.success": "已提交，等待管理员审批",
  "topup.tooManyPending": "你已有 {{count}} 条待审申请，请等管理员审批后再继续提交。",
  "topup.amountRange": "金额必须在 $1 到 $10000 之间",
  "topup.myRequests": "我的申请",
  "topup.myRequests.empty": "暂无申请记录。",
  "topup.openButton": "充值",
  "topup.status.pending": "待审批",
  "topup.status.approved": "已通过",
