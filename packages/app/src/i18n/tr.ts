...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "PunkcodeAI tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve PunkcodeAI'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "PunkcodeAI Cloud, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve PunkcodeAI'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak PunkcodeAI'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler punkcode.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi PunkcodeAI sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "PunkcodeAI'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı PunkcodeAI ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (punkcode.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: PunkcodeAI henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "PunkcodeAI ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "PunkcodeAI Masaüstü",
  ...
  "settings.desktop.wsl.description": "PunkcodeAI sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "PunkcodeAI'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "PunkcodeAI'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "PunkcodeAI'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "PunkcodeAI'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "PunkcodeAI başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "PunkcodeAI'un en son sürümünü kullanıyorsunuz.",
