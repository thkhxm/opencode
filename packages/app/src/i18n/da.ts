export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af PunkcodeAI",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i PunkcodeAI.",
  ...
  "provider.connect.opencodeZen.line1":
    "PunkcodeAI Cloud giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i PunkcodeAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i PunkcodeAI.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i punkcode.json",
  ...
  "dialog.server.description": "Skift hvilken PunkcodeAI-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af PunkcodeAI ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til PunkcodeAI-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (punkcode.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, PunkcodeAI understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "PunkcodeAI inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør PunkcodeAI-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for PunkcodeAI",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan PunkcodeAI ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om PunkcodeAI følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan PunkcodeAI er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når PunkcodeAI starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af PunkcodeAI.",
