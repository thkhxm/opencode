export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje PunkcodeAI",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u PunkcodeAI-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "PunkcodeAI Cloud ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u PunkcodeAI-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u PunkcodeAI-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u punkcode.json",
  ...
  "dialog.server.description": "Promijeni na koji se PunkcodeAI server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija PunkcodeAI-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku PunkcodeAI timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (punkcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: PunkcodeAI još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "PunkcodeAI uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni PunkcodeAI server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u PunkcodeAI-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako PunkcodeAI izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li PunkcodeAI prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu PunkcodeAI-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se PunkcodeAI pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju PunkcodeAI-a.",
