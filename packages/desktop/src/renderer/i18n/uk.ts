export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію PunkcodeAI",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} PunkcodeAI завантажено. Бажаєте встановити її та перезапустити?",
