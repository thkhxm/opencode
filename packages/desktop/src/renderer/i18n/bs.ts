export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju PunkcodeAI-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} PunkcodeAI-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
