export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de PunkcodeAI",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de PunkcodeAI. ¿Quieres instalarla y reiniciar?",
