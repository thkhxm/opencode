export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'PunkcodeAI",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'PunkcodeAI a été téléchargée. Voulez-vous l'installer et redémarrer ?",
