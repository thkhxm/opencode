export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von PunkcodeAI",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von PunkcodeAI wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
