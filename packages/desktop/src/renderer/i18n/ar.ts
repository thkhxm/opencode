export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من PunkcodeAI",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من PunkcodeAI، هل ترغب في تثبيته وإعادة تشغيله؟",
