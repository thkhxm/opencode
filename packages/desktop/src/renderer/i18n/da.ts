export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af PunkcodeAI",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af PunkcodeAI er blevet downloadet. Vil du installere den og genstarte?",
