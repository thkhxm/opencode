export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of PunkcodeAI",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of PunkcodeAI has been downloaded, would you like to install it and relaunch?",
