export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av PunkcodeAI",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av PunkcodeAI er lastet ned. Vil du installere den og starte på nytt?",
