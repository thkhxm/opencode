export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji PunkcodeAI",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} PunkcodeAI. Czy chcesz ją zainstalować i uruchomić ponownie?",
